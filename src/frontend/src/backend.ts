...
export class Backend implements backendInterface {
    ...
    async addBranch(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addBranch(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addHero(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addHero(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addItem(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addItem(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteHero(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getBranches(): Promise<Array<CatalogEntry>> {
        if (this.processError) {
            try {
    ...
    async getHeroes(): Promise<Array<CatalogEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getHeroes();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getItems(): Promise<Array<CatalogEntry>> {
        if (this.processError) {
            try {
    ...
    async initializeCatalogs(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initializeCatalogs();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateBranch(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateBranch(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateHero(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateHero(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateItem(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
